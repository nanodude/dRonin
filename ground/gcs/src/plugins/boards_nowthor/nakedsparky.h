 ...
 */
#ifndef NAKEDSPARKY_H
#define NAKEDSPARKY_H

#include <coreplugin/iboardtype.h>

class IBoardType;

class NakedSparky : public Core::IBoardType
{
public:
    NakedSparky();
    virtual ~NakedSparky();
     ...
     */
    virtual QString getConnectionDiagram() { return ":/nowthor/images/nakedsparky-connection-diagram.svg"; }
